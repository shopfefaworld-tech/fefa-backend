  ...
  res.status(200).json({
    ...
    endpoints: {
      ...
      auth: {
        method: 'GET',
        path: '/api/auth',
        description: 'Authentication API info',
        requiresAuth: false,
        testUrl: `${baseUrl}/api/auth`
      },
      'auth-register': {
        method: 'POST',
        ...
        requiresAuth: false,
        testUrl: `${baseUrl}/api/auth/register`
      },
      'auth-login': {
        method: 'POST',
        path: '/api/auth/login',
        ...
        requiresAuth: false,
        testUrl: `${baseUrl}/api/auth/login`
      },
      'auth-me': {
        method: 'GET',
        path: '/api/auth/me',
      ...
      categories: {
        ...
        requiresAuth: false,
        testUrl: `${baseUrl}/api/categories`
      },
      cart: {
        method: 'GET',
        path: '/api/cart',
      ...
      reviews: {
        ...
        requiresAuth: false,
        testUrl: `${baseUrl}/api/reviews`
      }
    },
    testing: {
      note: 'Use the testUrl to test each endpoint',
      publicEndpoints: 'Endpoints without requiresAuth can be tested directly',
      authEndpoints: 'Endpoints with requiresAuth need Authorization: Bearer <token> header',
      adminEndpoints: 'Endpoints with requiresAdmin need admin token'
    }
  });
});
